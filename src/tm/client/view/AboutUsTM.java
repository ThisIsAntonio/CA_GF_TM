...
/**
 * AboutUs class represents a JFrame that provides to the user information about
 * (programmers).
 * 
 ...
 * 
 */
public class AboutUsTM extends JFrame {
	...
	/**
	 * Constructor for the AboutUs class. Initializes the UI components and sets up
	 * event listeners.
	 * 
	 * @param locale The current language being used by the application
	 */
	public AboutUsTM(Locale locale) {
		...
		aboutText.setText(
				"<html><body style='text-align: justify;'>" + bundle.getString("aboutUsInfoTM") + "</body></html>");
