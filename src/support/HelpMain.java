...
/**
 * Help Main class represents a JFrame that provides to the user information about this application works.
 * 
...
public class HelpMain extends JFrame {
	...
	/**
	 * Constructor for the Help class. Initializes the UI components and sets up event listeners.
	 * @param locale The current language being used by the application
	 */
	public HelpMain(Locale locale) {
        ...
        helpText.setEditable(false);									// Text box for display purposes only
        helpText.setText("<html><body style='text-align: justify;'>" + bundle.getString("helpInfo") + "</body></html>");
