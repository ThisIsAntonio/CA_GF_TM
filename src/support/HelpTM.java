 ...
 * 
 */
public class HelpTM extends JFrame {
	...
	public HelpTM(Locale locale) {
        ...
        helpText.setText("<html><body style='text-align: justify;'>" + bundle.getString("helpInfoTM") + "</body></html>");
