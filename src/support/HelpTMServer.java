 ...
 * 
 */
public class HelpTMServer extends JFrame {
	 ...
	 */
	public HelpTMServer(Locale locale) {
        ...
        helpText.setText("<html><body style='text-align: justify;'>" + bundle.getString("helpInfoTMServer") + "</body></html>");
